...
logger = logging.getLogger("SweepAndReclaimFinal")
...
async def main():
    ...
    mints = [
        ...
        "HuoR8S3rFTNvMfVhkmySb15EqWfqv1X5n6xVocaXpump" # Dead HuoR8S
    ]
        ...
        for mint_str in mints:
            ...
            try:
                ...
                if "result" in resp_json:
                    ...
                    if raw_amount > 0:
                        logger.info(f"  Adding Token2022 burn instruction for {raw_amount} raw tokens...")
                        burn_inst = burn(
                            BurnParams(
                    ...
                    logger.warning(f"No result found for ATA {ata}: {resp_json}")
            except Exception as e:
            ...
            try:
                ...
                if sig:
                    ...
                    if status_val and status_val.get("err") is None:
                        logger.info("Transaction confirmed! All 5 Token2022 accounts processed, burned, and closed successfully! SOL clawed back!")
                        break
                    else:
